package br.com.andebem.components.controls.autocomplete
{
	...
	[Event(name="select", type="br.com.andebem.components.controls.autocomplete.event.AutoCompleteEvent")]
	...
	public class AutoComplete extends SkinnableComponent
	{
		...
		public function acceptCompletion():void
		{
			if(list.selectedIndex >= 0 && collection.length > 0)
			{
				...
				_selectedItem = collection.getItemAt(selectedIndex)
			...
			{
				selectedIndex = list.selectedIndex = -1
				_selectedItem = null
			}
