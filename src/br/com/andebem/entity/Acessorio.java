...
@SequenceGenerator(name = "acessorio_id_seq", sequenceName = "acessorio_id_seq", initialValue = 1)
public class Acessorio extends AbstractEntity {

	@Id
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "acessorio_id_seq")
	private Long id;
	@Column(length = 30)
	private String nome;
